...
const highlightCompetitions = ref<Competition[]>([
  {
    ...
    cover: 'https://ts3.tc.mm.bing.net/th/id/OIP-C.hUFsntYr7oe0Hy-e0df8wAHaFj?r=0&rs=1&pid=ImgDetMain&o=7&rm=3',
    category: 'scratch',
  ...
  },
  {
    ...
    cover: 'https://tse2-mm.cn.bing.net/th/id/OIP-C.BxNj-RG7FcBgR1dXrwyJ-gHaDl?w=274&h=169&c=7&r=0&o=7&dpr=1.5&pid=1.7&rm=3',
    category: 'scratch',
    difficulty: 'beginner',
    status: 'ongoing',
